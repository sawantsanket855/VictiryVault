...
class _ScoreAppState extends State {
  ...
  child: Container(
    decoration: BoxDecoration(
      color: const Color(0xFFE1F5FE), // Light Blue background for a fresh feel
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            "Team A ,1st innings",
            style: GoogleFonts.oxygen(
                fontSize: 15, fontWeight: FontWeight.w500, color: Color(0xFF0277BD)), // Dark Blue
          ),
          const SizedBox(
            height: 8,
          ),
          Row(
            children: [
              Text(
                "$score-$wicket",
                style: GoogleFonts.oxygen(
                    fontSize: 38, fontWeight: FontWeight.w700, color: Color(0xFF0277BD)), // Dark Blue
              ),
              const SizedBox(
                width: 15,
              ),
              Text(
                ...
                style: GoogleFonts.quicksand(
                    fontSize: 20, fontWeight: FontWeight.w300, color: Color(0xFF0288D1)), // Lighter Blue
              ),
              const Spacer(),
              Column(
                children: [
                  ...
                  Text(
                    "0.00",
                    style: GoogleFonts.quicksand(
                        fontSize: 18, fontWeight: FontWeight.w700, color: Color(0xFF4CAF50)), // Green for CRR
                  ),
                ],
              ),
            ],
  ...
  children: [
    ...
    Padding(
      ...
      child: Container(
        ...
        decoration: const BoxDecoration(
          color: Color.fromARGB(255, 248, 249, 250), // Light gray background
        ...
        child: const Padding(
          ...
          child: Row(
            children: [
              ...
              Spacer(),
              SizedBox(width: 24, height: 20, child: Text("R")),
              SizedBox(width: 16),
              SizedBox(width: 24, height: 20, child: Text("B")),
              SizedBox(width: 16),
              SizedBox(width: 24, height: 20, child: Text("4s")),
              SizedBox(width: 16),
              SizedBox(width: 24, height: 20, child: Text("6s")),
              SizedBox(width: 16),
              SizedBox(width: 24, height: 20, child: Text("SR")),
            ],
          ),
        ),
      ),
    ...
    for (int i = 1; i <= 2; i++)
      Padding(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: i % 2 == 0
                ?   Color.fromRGBO(212, 246, 255, 1)// Alternating row colors
                :  Color.fromRGBO(124, 224, 182, 1),
            border: Border(
              bottom: BorderSide(
                color: const Color(0xFFdee2e6), // Border between rows
                width: 0.5,
              ),
            ),
          ),
        ...
        child: const Padding(
          ...
          child: Row(
            children: [
              ...
              Spacer(),
              SizedBox(width: 24, height: 20, child: Text("O")),
              SizedBox(width: 16),
              SizedBox(width: 24, height: 20, child: Text("M")),
              SizedBox(width: 16),
              SizedBox(width: 24, height: 20, child: Text("R")),
              SizedBox(width: 16),
              SizedBox(width: 24, height: 20, child: Text("W")),
              SizedBox(width: 16),
              SizedBox(width: 24, height: 20, child: Text("ER")),
            ],
          ),
        ),
      ),
    ...
    Padding(
      ...
      child: Container(
        width: MediaQuery.of(context).size.width,
        decoration: const BoxDecoration(
          color: Color.fromRGBO(124, 224, 182, 1),
          borderRadius: BorderRadius.only(
        ...
        child: const Padding(
          ...
          child: Row(
            children: [
              ...
              Spacer(),
              SizedBox(width: 24, height: 20, child: Text("0")),
              SizedBox(width: 16),
              SizedBox(width: 24, height: 20, child: Text("0")),
              SizedBox(width: 16),
              SizedBox(width: 24, height: 20, child: Text("0")),
...
Container(
  ...
  decoration: BoxDecoration(
    borderRadius: BorderRadius.circular(5),
    color: const Color(0xFFBBDEFB), // Soft light blue background for a fresh look
  ),
  child: Column(
    children: [
      Row(
        children: [
          ...
          const Text(
            "Wide",
            style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500, color: Color(0xFF0288D1)), // Blue color for consistency
          ),
          const SizedBox(
            width: 10,
          ),
          ...
          const Text(
            "No Ball",
            style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500, color: Color(0xFF0288D1)), // Blue color
          ),
          const SizedBox(
            width: 10,
          ),
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: () {},
              style: ButtonStyle(
                backgroundColor: MaterialStateProperty.all(const Color.fromARGB(255, 247, 177, 24)),
              ),
