...
class KabaddiPointsTable extends StatefulWidget {
  @override
  State<KabaddiPointsTable> createState() => _KabaddiPointsTableState();
}

class _KabaddiPointsTableState extends State<KabaddiPointsTable> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Kabaddi Points Table'),
        backgroundColor: Colors.green,
        elevation: 2,
      ),
      body:
      isLoding? FullScreenShimmer():
       Padding(
